...
- Name: app.spec.ts >> Login >> should show error with empty credentials
- Location: e2e\app.spec.ts:33:3
...
Locator: locator('text=username and password are required')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=username and password are required')

```

```yaml
- img "Bayanihan Bank"
- text: BAYANIHAN BANK IT Service Desk Portal
- paragraph: Centralized IT Support & Service Management for Branches and Main IT
- text: Username
- textbox "e.g. branch.user or it.staff"
- text: Password
- textbox "••••••••"
...
- button "Access IT Portal"
- contentinfo: Bayanihan Bank IT Service Desk (August 7, 2026)
```
